    ...
    <div>
      ...
      <div className='mt-14 flex w-[1150px] flex-col items-center justify-center'>
        ...
        <div className='mt-3 flex gap-4'>
          ...
          {/* advanced search */}
          <div className='h-full w-[470px] rounded-lg border border-secondaryContainerBorder'>
            ...
            <div className='border-y-2 border-primary border-opacity-10 p-8'>
            ...
            {/* categories */}
            <div className='flex flex-col gap-6 border-primary border-opacity-10 p-8 pb-12'>
